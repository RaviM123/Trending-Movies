...
filterarr = filterarr.slice(si,ei);
  ...
  <thead>
    <tr>
      ...
      <th scope="col"><i class="fas fa-caret-up" onClick={this.sortPopularityDesc}/>Popularity<i class="fas fa-sort-down" onClick={this.sortPopularityAcen}></i></th>
      <th scope="col"><i class="fas fa-caret-up" onClick={this.sortRatingDesc}></i>Rating<i class="fas fa-sort-down" onClick={this.sortRatingAcen}></i></th>
    </tr>
  </thead>
  <tbody>
      {
